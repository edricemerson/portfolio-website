  ...
  ],
  {
    variants: {
      ...
      gradient: {
        ...
        glass:
          "bg-[conic-gradient(from_90deg_at_50%_50%,rgba(255,255,255,0.15)_0%,rgba(251,113,133,0.55)_50%,rgba(255,255,255,0.15)_100%)] ",
      },
    },
    compoundVariants: [
      {
  ...
  "relative px-6 py-2    transition-all duration-150 ease-in-out disabled:pointer-events-none disabled:opacity-50 text-sm  overflow-hidden",
  {
    variants: {
      ...
      gradient: {
        ...
        glass:
          "bg-white/10 backdrop-blur-xl border border-white/20 text-white font-medium",
      },
      rounded: {
        full: "rounded-full before:rounded-full",
        xl: "rounded-xl before:rounded-xl",
...
export { BgAnimateButton, outerDivVariants, innerSpanVariants, buttonVariants }
